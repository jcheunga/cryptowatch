...
export default class CoinInfo extends React.PureComponent {
  ...
  _renderFavouritesButton = () => {
    ...
    if (favourite) {
      return (
        <View>
          <TouchableOpacity onPress={this._changeFavouriteStatus}>
            <Image style={{ width: 26, height: 26 }} source={require('../../img/star-favourited.png')}/>
          </TouchableOpacity>
        </View>
      )
    } else {
      return (
        <View>
          <TouchableOpacity onPress={this._changeFavouriteStatus}>
          <Image style={{ width: 26, height: 26 }} source={require('../../img/star-notfavourited.png')}/>
          </TouchableOpacity>
        </View>
      )
    }
